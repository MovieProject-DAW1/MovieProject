...
var News = [
    {
        ...
        link : "http://localhost:63342/MovieProject/News/newWalking.html"
    },
    ...
    },
    {
        ...
        link : "http://localhost:63342/MovieProject/News/newWonka.html"
...

    {
        ...
        link : "http://localhost:63342/MovieProject/News/newJurassic.html"
    },
    {
        name : "'The Walking Dead': estos son los nuevos personajes a los que debes prestar atención",
        id : "link-inde",
    ...
    for (var i = 0; i < News.length; i++){
        contentHTML += '<div class="row shadow p-3 mb-5 bg-white rounded">\n' +
                            ...
                            //'<a class="link" href="http://localhost:63342/MovieProject/News/News1.html">\n' +
                                '<a class="link" href="' + News[i].link + '" </a>' +
...
$( document ).ready(function(){
    var contentHTML ='';
    for (var i = 0; i < News.length; i++){
        contentHTML += '<div class="carousel-item">\n' +
            '<img class="d-block w-100" src="' + News[i].image  +'" alt="Image" </img> '+
...
$( document ).ready(function(){
    ...
    for (var i = 0; i < News.length; i++){
        contentHTML += '<div class="col-sm-2 lightbox">' +
            '<a href="#x"><img src="http://localhost:63342/MovieProject/News/imgs/walking.jpg" alt="Image" class="img-responsive"></a>' +
    ...
    console.log(document.getElementById( 'content-month' ));
    document.getElementById( 'content-month' ).innerHTML = contentHTML;
